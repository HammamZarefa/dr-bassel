    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.diagnoses.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('chief_complaint') ? 'is-invalid' : '' }}" name="chief_complaint" id="chief_complaint">{{ old('chief_complaint') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('medical_history') ? 'is-invalid' : '' }}" name="medical_history" id="medical_history">{{ old('medical_history') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('clinical_examination') ? 'is-invalid' : '' }}" name="clinical_examination" id="clinical_examination">{{ old('clinical_examination') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('abdominal_examination') ? 'is-invalid' : '' }}" name="abdominal_examination" id="abdominal_examination">{{ old('abdominal_examination') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('abdominal_ultrasound') ? 'is-invalid' : '' }}" name="abdominal_ultrasound" id="abdominal_ultrasound">{{ old('abdominal_ultrasound') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('laboratory_tests') ? 'is-invalid' : '' }}" name="laboratory_tests" id="laboratory_tests">{{ old('laboratory_tests') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('upper_endoscopy') ? 'is-invalid' : '' }}" name="upper_endoscopy" id="upper_endoscopy">{{ old('upper_endoscopy') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('lower_endoscopy') ? 'is-invalid' : '' }}" name="lower_endoscopy" id="lower_endoscopy">{{ old('lower_endoscopy') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('ercp') ? 'is-invalid' : '' }}" name="ercp" id="ercp">{{ old('ercp') }}</textarea>
                @if($errors->has('ercp'))
                    <div class="invalid-feedback">
                        {{ $errors->first('ercp') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('further_investigations') ? 'is-invalid' : '' }}" name="further_investigations" id="further_investigations">{{ old('further_investigations') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('diagnosis') ? 'is-invalid' : '' }}" name="diagnosis" id="diagnosis">{{ old('diagnosis') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('treatment') ? 'is-invalid' : '' }}" name="treatment" id="treatment">{{ old('treatment') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('follow_up') ? 'is-invalid' : '' }}" name="follow_up" id="follow_up">{{ old('follow_up') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rr') ? 'is-invalid' : '' }}" type="text" name="rr" id="rr" value="{{ old('rr', '') }}">
                @if($errors->has('rr'))
                    <div class="invalid-feedback">
                        {{ $errors->first('rr') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hr') ? 'is-invalid' : '' }}" type="text" name="hr" id="hr" value="{{ old('hr', '') }}">
                @if($errors->has('hr'))
                    <div class="invalid-feedback">
                        {{ $errors->first('hr') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bp') ? 'is-invalid' : '' }}" type="text" name="bp" id="bp" value="{{ old('bp', '') }}">
                @if($errors->has('bp'))
                    <div class="invalid-feedback">
                        {{ $errors->first('bp') }}
                    </div>
